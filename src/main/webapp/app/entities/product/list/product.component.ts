...
export class ProductComponent implements OnInit {
  ...
  getProductStatus(value?: number | null): string | undefined {
    const productStatus = this.productStatusList?.find(item => item.value === value);
  ...
  load(): void {
    this.loadSetupService.loadPicklist().subscribe(res => {
      if (res.body) {
        this.productStatusList = res.body.catetoryStatusList;
      }
    });
