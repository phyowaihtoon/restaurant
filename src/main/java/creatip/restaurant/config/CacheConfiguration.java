...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, creatip.restaurant.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, creatip.restaurant.repository.UserRepository.USERS_BY_EMAIL_CACHE);
