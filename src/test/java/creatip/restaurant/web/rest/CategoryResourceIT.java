...
import creatip.restaurant.repository.CategoryRepository;
...
class CategoryResourceIT {
    ...
    public static Category createUpdatedEntity(EntityManager em) {
        Category category = new Category().code(UPDATED_CODE).name(UPDATED_NAME).status(UPDATED_STATUS);
        return category;
    }
    ...
    void putExistingCategory() throws Exception {
        ...
        updatedCategory.code(UPDATED_CODE).name(UPDATED_NAME).status(UPDATED_STATUS);
    ...
    void partialUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.code(UPDATED_CODE).status(UPDATED_STATUS);
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.code(UPDATED_CODE).name(UPDATED_NAME).status(UPDATED_STATUS);
