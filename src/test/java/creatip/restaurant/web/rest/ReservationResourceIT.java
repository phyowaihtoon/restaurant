...
import creatip.restaurant.repository.ReservationRepository;
import creatip.restaurant.service.ReservationService;
import creatip.restaurant.service.dto.ReservationDTO;
import creatip.restaurant.service.mapper.ReservationMapper;
...
class ReservationResourceIT {
    ...
    private static final Instant DEFAULT_RESERVED_DATE = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_RESERVED_DATE = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    public static Reservation createEntity(EntityManager em) {
        Reservation reservation = new Reservation().name(DEFAULT_NAME).phone(DEFAULT_PHONE).reservedDate(DEFAULT_RESERVED_DATE);
        return reservation;
    }
    ...
    public static Reservation createUpdatedEntity(EntityManager em) {
        Reservation reservation = new Reservation().name(UPDATED_NAME).phone(UPDATED_PHONE).reservedDate(UPDATED_RESERVED_DATE);
        return reservation;
    }
    ...
    void createReservation() throws Exception {
        ...
        assertThat(testReservation.getReservedDate()).isEqualTo(DEFAULT_RESERVED_DATE);
    }
    ...
    void putExistingReservation() throws Exception {
        ...
        updatedReservation.name(UPDATED_NAME).phone(UPDATED_PHONE).reservedDate(UPDATED_RESERVED_DATE);
        ...
        assertThat(testReservation.getReservedDate()).isEqualTo(UPDATED_RESERVED_DATE);
    }
    ...
    void partialUpdateReservationWithPatch() throws Exception {
        ...
        partialUpdatedReservation.reservedDate(UPDATED_RESERVED_DATE);
    ...
    void fullUpdateReservationWithPatch() throws Exception {
        ...
        partialUpdatedReservation.name(UPDATED_NAME).phone(UPDATED_PHONE).reservedDate(UPDATED_RESERVED_DATE);
